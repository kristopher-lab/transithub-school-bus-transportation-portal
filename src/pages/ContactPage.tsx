    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-20 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <section className="space-y-8">
          ...
          <form className="space-y-6 bg-white dark:bg-slate-950 p-8 rounded-3xl border-2 border-slate-100 dark:border-slate-800 shadow-xl">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="message" placeholder="Details of your inquiry..." className="min-h-[150px] rounded-xl" />
            </div>
            <Button className="w-full h-14 bg-secondary font-black uppercase italic group">
